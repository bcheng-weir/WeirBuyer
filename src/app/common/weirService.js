...
function WeirService($q, $cookieStore, $sce, OrderCloud, CurrentOrder, buyerid, SearchTypeService) {
    var orderStatuses = {
        ...
        SubmittedWithPO: { id: "SP", label: { en: "Order submitted with PO", fr: "Commande soumise avec bon de commande" }, desc: "Order has been submitted to Weir with a PO" },
        SubmittedPendingPO: { id: "SE", label: { en: "Order submitted pending PO", fr: "Commandes soumise en attente de bon de commande" }, desc: "Order has been submitted to Weir with the expectation of a PO to be sent via email" },
...
>>>>>>> fbd52e84c9163a37ca09ec1d8101a8fd970b2f3d
