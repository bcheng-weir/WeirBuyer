...
function HomeController($sce, $state, WeirService, SearchProducts, Me, SearchTypeService) {
    ...
    var labels = {
        en: {
            ...
            DeatilsSearchMsg : "Search by Weir serial number, Weir part number or your Tag number. Search and view spares associated valve.",
        ...
        fr: {
            ...
            DeatilsSearchMsg : $sce.trustAsHtml("Rechercher par numéro de série Weir, numéro de pièce Weir ou votre numéro de tag. Parcourez la recherche de résultats et visualisez les pièces associées associées."),
